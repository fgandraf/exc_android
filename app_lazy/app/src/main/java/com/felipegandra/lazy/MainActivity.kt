...
import com.felipegandra.lazy.model.Game
import com.felipegandra.lazy.repository.getGamesByStudio
...
fun GamesScreen() {
    ...
    var listGamesByStudio by remember { mutableStateOf(getGamesByStudio(studioState)) }
